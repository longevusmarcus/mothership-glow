...
const initialAgents = [
  { id: 1, name: "Nova", role: "Full-Stack Dev", score: 96, stage: "Shortlist", aiParsed: true, jobPosition: "NovaTech", source: "tech", skills: ["React", "TypeScript", "Node.js", "PostgreSQL"], telegram: "Nova_MSX_bot", status: "active" as const, isCeo: true },
  ...
  { id: 3, name: "Medi", role: "UI/UX Design", score: 87, stage: "Shortlist", aiParsed: false, jobPosition: "HealthAI", source: "creative", skills: ["Figma", "Design Systems", "Prototyping"], telegram: "Medi_MSX_bot", status: "pending" as const, isCeo: true },
  { id: 4, name: "Pulse", role: "Data Pipeline", score: 94, stage: "Placement", aiParsed: true, jobPosition: "DataPulse", source: "tech", skills: ["Python", "SQL", "Spark", "Airflow"], telegram: "Pulse_MSX_bot", status: "active" as const, isCeo: true },
  { id: 5, name: "Finn", role: "DevOps & CI/CD", score: 89, stage: "Screening", aiParsed: false, jobPosition: "FinFlow", source: "ops", skills: ["Docker", "Kubernetes", "Terraform", "AWS"], telegram: "Finn_MSX_bot", status: "pending" as const, isCeo: true },
