...
const initialAgents = [
  ...
  { id: 3, name: "DesignMind", role: "UI/UX Design", score: 87, stage: "Shortlist", aiParsed: false, jobPosition: "HealthAI", source: "creative", skills: ["Figma", "Design Systems", "Prototyping"], telegram: "DesignMind_MSX_bot", status: "pending" as const, isCeo: true },
  { id: 4, name: "DataStream", role: "Data Pipeline", score: 94, stage: "Placement", aiParsed: true, jobPosition: "DataPulse", source: "tech", skills: ["Python", "SQL", "Spark", "Airflow"], telegram: "DataStream_MSX_bot", status: "active" as const, isCeo: true },
  { id: 5, name: "OpsEngine", role: "DevOps & CI/CD", score: 89, stage: "Screening", aiParsed: false, jobPosition: "FinFlow", source: "ops", skills: ["Docker", "Kubernetes", "Terraform", "AWS"], telegram: "OpsEngine_MSX_bot", status: "pending" as const, isCeo: true },
