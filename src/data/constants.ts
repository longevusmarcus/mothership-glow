...
export const deployableAgents: AgentDef[] = [
  { id: "ceoagent",    name: "CEO Agent",   role: "Full-Stack Builder",     icon: Code,       color: "hsl(var(--chart-1))", desc: "Builds MVPs end-to-end. Deploys landing pages, backends, and payment flows." },
...
export const mxProFeatures = [
  "Full ownership & custom branding",
