  ...
  return (
    <>
      ...
      >
        ...
        {/* Border */}
        <div className="pointer-events-none absolute inset-0 rounded-[inherit] border border-foreground/10" />
        ...
        {/* Shine */}
        <div className="pointer-events-none absolute inset-0 rounded-[inherit] bg-gradient-to-b from-white/20 to-transparent opacity-60" />
      </Comp>
      <GlassFilter />
    </>
  )
  ...
  return (
    <div
      ...
      style={{
        ...
        transition: "opacity 250ms cubic-bezier(0.1, 0.4, 0.2, 1)",
      }}
    >
      <div
