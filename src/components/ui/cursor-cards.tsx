...
export function CursorCard({
  ...
  return (
    <div ref={elementRef} className={cn("relative rounded-xl", className)}>
      ...
      {/* Card body */}
      <div className="relative z-10 h-full overflow-hidden rounded-xl border border-border bg-card">
        <motion.div
